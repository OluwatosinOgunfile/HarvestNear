export const faqKnowledge = [
  ...
  { title: "Delivery and pickup", keywords: ["delivery","doorstep","pickup","collect","farmer delivery"], answer: "At checkout, choose doorstep delivery at ₦250 per kilometre with a ₦250 minimum, free farm pickup, or arrange delivery directly with the farmer. Doorstep delivery is only listed when every farm in your basket offers it and your saved location falls inside their delivery radius." },
