...
const captions = [
  { title: "Consumer launch", text: "The freshest food may be closer than you think. Discover today’s harvest from trusted farmers near you, order the quantity you need, and choose pickup or doorstep delivery. Shop local with HarvestNearU." },
  { title: "Farmer recruitment", text: "Your next customer could be just a few kilometres away. List what you have available, sell in practical quantities, and reach nearby households with HarvestNearU." },
  { title: "WhatsApp broadcast", text: "Fresh harvests are now closer 🌿 Shop tomatoes, yam, grains, fruits and more from trusted farmers near you. Choose pickup or delivery and pay securely. Visit HarvestNearU today." },
];
    ...
    <section className="kit-section"><div className="section-label"><span>01</span><div><h2>Consumer campaign</h2><p>Awareness and marketplace launch</p></div></div>
      <div className="creative-row">
        ...
        <article className="creative story-poster">
          ...
          <div className="story-copy"><small>FROM FARM GATE TO YOUR PLATE</small><h3>Fresh starts<br/>near you.</h3><p>Real farmers. Daily availability.<br/>Pickup or doorstep delivery.</p><span>HARVESTNEARU.NG <b>→</b></span></div>
        </article>
      </div>
    </section>
