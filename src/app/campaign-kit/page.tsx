...
const captions = [
  { title: "Consumer launch", text: "The freshest food may be closer than you think. Discover available produce from verified farms, compare estimated walking times, open farm maps and directions, choose how to receive your order, and track every item to receipt. Shop local at harvestnearu.com." },
  { title: "Farmer recruitment", text: "Your next customer could be nearby. Create one account for multiple farms, publish live stock, manage every item, build trust through verified buyer ratings, and request clear farm payouts on HarvestNearU." },
  { title: "WhatsApp broadcast", text: "Fresh harvests are closer. Shop produce from verified farms near you, then choose doorstep delivery, free farm pickup, or arrange delivery with the farmer. Pay securely and follow every item. Visit harvestnearu.com." },
];
  ...
  return <main className="campaign-kit">
    ...
    <section className="kit-section"><div className="section-label"><span>01</span><div><h2>Consumer campaign</h2><p>Awareness and marketplace launch</p></div></div>
      <div className="creative-row">
        ...
        <article className="creative story-poster">
          ...
          <div className="story-copy"><small>FROM FARM GATE TO YOUR PLATE</small><h3>Fresh starts<br/>near you.</h3><p>Verified farms. Live stock.<br/>Maps, directions, and item tracking.</p><span>HARVESTNEARU.COM <b>→</b></span></div>
        </article>
      </div>
    </section>
    ...
    <section className="kit-section"><div className="section-label"><span>02</span><div><h2>Farmer recruitment</h2><p>Supply-side onboarding campaign</p></div></div>
      <article className="creative farmer-banner">
        ...
        <div className="farmer-message"><small>FOR FARMERS</small><h3>Your harvest already<br/>has buyers nearby.</h3><p>Manage multiple farms. Fulfil every item.<br/>Request payouts and grow through verified ratings.</p><button><Store size={16}/> Start selling on HarvestNearU</button></div>
    ...
    <section className="kit-section"><div className="section-label"><span>03</span><div><h2>Launch announcement</h2><p>Website, X, LinkedIn and digital display</p></div></div>
      <article className="creative launch-banner"><div className="launch-brand"><img src="/brand/harvestnearu-approved-mark.png" alt="HarvestNearU"/></div><div className="launch-copy"><small>NOW SERVING ABUJA</small><h3>Fresh local produce,<br/><em>found right here.</em></h3><p>Visit farm storefronts, get directions, pay securely, and track every item.</p><div><span><Truck size={14}/> Three fulfilment choices</span><span><Check size={14}/> Verified farms</span></div></div><div className="launch-collage"><img src="/produce/golden-pineapple.webp" alt="Pineapple"/><img src="/produce/red-scotch-bonnet.webp" alt="Pepper"/><img src="/produce/creamy-avocados.webp" alt="Avocado"/></div></article>
    </section>
