...
function listingStatusLabel(status: unknown) {
  ...
  return value === "sold_out" ? "Out of stock" : value.replaceAll("_", " ");
}
...
export default function Home() {
  ...
  async function beginCheckout() {
    try {
      ...
      setPaystackAvailable(Boolean(settingsResult.paystackAvailable));
      setPaymentMethod(settingsResult.paystackAvailable ? "paystack" : "manual");
...
function CustomerOrderCard({ order, active, expanded, receiptBusy, onToggle, onUpload, onPaystack, onCancel, onConfirm, onRating }: { order: CustomerOrder; active: boolean; expanded: boolean; receiptBusy: boolean; onToggle: () => void; onUpload: (file: File | undefined) => void; onPaystack: () => void; onCancel: () => void; onConfirm: (item: CustomerOrder["items"][number]) => void; onRating: (farm: CustomerOrder["farms"][number]) => void }) {
